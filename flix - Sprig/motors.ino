...
// Motor pin mapping for the Sprig-C3 (ESP32-C3) build:
//   index 0 = rear left, 1 = rear right, 2 = front right, 3 = front left
int motorPins[4] = {6, 5, 7, 4};
// ESP32-C3 LEDC max frequency at 10-bit resolution is ~39 kHz, so the motor
// PWM frequency must be lowered from 78000 (used on the original ESP32 build).
